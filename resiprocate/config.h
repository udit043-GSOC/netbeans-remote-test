...
#define PACKAGE_STRING "resiprocate 1.9.0~rc2"
...
#define PACKAGE_VERSION "1.9.0~rc2"

/* PEDANTIC_STACK */
/* #undef PEDANTIC_STACK */

/* Host where package was configured */
#define REPRO_BUILD_HOST "vip216"
